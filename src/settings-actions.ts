import { clientSecretId, isClientSecretReferenceId, TaskSyncerSettings } from "./settings-model";
...
export async function changeProviderClientSecret(
	...
	const id = clientSecretId(settings.provider);
	settings.providers[settings.provider].clientSecretId = id;
